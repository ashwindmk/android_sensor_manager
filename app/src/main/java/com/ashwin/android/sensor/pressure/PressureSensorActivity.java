package com.ashwin.android.sensor.pressure;
...
public class PressureSensorActivity extends AppCompatActivity implements SensorEventListener2 {
    private static final String SUB_TAG = PressureSensorActivity.class.getSimpleName();

    public static void launch(Context context) {
        context.startActivity(new Intent(context, PressureSensorActivity.class));
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (SensorUtils.sensorAvailable(this, Sensor.TYPE_PRESSURE)) {
            ...
            infoTextView.setText(SensorUtils.getSensorAttributes(pressureSensor));
        } else {
    ...
    private void register() {
        boolean res = sensorManager.registerListener(this, pressureSensor, SensorManager.SENSOR_DELAY_NORMAL);
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        valueTextView.setText("Value: " + values[0] + " hPa");
    }
